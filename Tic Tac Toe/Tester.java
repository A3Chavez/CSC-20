public class Tester {
    ...
    public static void main(String[] args) {
        ...
        expected = " |O|X\n-+-+-\n |O|X\n-+-+-\n | |X";
        pass = pass && (b.toString().indexOf(expected)==0);
        System.out.println(pass); // pass 4 turns false here but everything else is good
        ...
        try {
            ...
            pass = false;
            System.out.println(pass + "need to throw an exception"); // shouldn't get here
        }
        ...
        // Print final result
        System.out.println(pass); // final pass 
    }
